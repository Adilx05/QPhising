...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$requiredPaths=@('/api/proxy-validation/assert-sync','/api/configuration','/api/setup/status','/api/setup/guard-decision','/api/setup/test-db','/api/setup/test-redis','/api/setup/test-keycloak','/api/setup/save','/api/campaigns','/api/campaigns/{campaignId}','/api/campaigns/{campaignId}/targets','/api/campaigns/{campaignId}/targets/{targetId}','/api/campaigns/{campaignId}/schedule','/api/campaigns/{campaignId}/start','/api/campaigns/{campaignId}/pause','/api/campaigns/{campaignId}/complete','/api/campaigns/{campaignId}/cancel','/api/templates','/api/templates/{templateId}','/api/templates/{templateId}/publish','/api/templates/{templateId}/archive');" ^
