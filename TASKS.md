...
- 2026-04-19: Added runtime rehydration fallback to inherit Redis cipher text from persisted `SetupWizardState` when runtime section omits Redis, keeping setup-derived readiness consistent during endpoint persistence workflows.
