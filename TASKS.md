...
- 2026-04-20: Fixed PDF download corruption/blank-page issue by enabling binary (`blob`) response handling in generated OpenAPI proxy requests for report export, deferring object-URL revocation after browser download trigger, and removing leftover debug disk-write side effect in backend PDF exporter.
